...
<?php require 'form.php'; ?>
	...
	<div class="social">
		...
		<a href="https://twitter.com/nj_ferrari"><img class="icon" src="assets/images/icons/twitter.png" alt="Twitter"></a>
	...
	<script async src="https://www.googletagmanager.com/gtag/js?id=UA-163107434-1"></script>
	<script>
	  window.dataLayer = window.dataLayer || [];
	  function gtag(){dataLayer.push(arguments);}
	  gtag('js', new Date());

	  gtag('config', 'UA-163107434-1');
	</script>
